...
<head>
    ...
    <script type="text/javascript" src="js/edit_game.js"></script>
</head>
<body onload="loadVideogame()">
    <div id="wrapper">
        <?php include('nav.php');?>
        <div>
            ...
            <div class="container">
                <div class="col-lg-12">
                    <h1> Editar Videojuego <small></small></h1>
                    <hr/>
                </div>
                <div>
                    ...
                    <div class="form">
                        ...
                        <div class="col-md-9">
                            <button onclick="edit_videogame()" type="submit" class="form-control btn btn-large btn-info">
                                Editar
                            </button>
                        </div>
                    </div>
